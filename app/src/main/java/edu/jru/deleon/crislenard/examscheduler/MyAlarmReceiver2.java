...
public class MyAlarmReceiver2 extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        bd = admin.getWritableDatabase();
            ...
            if(bd!=null) {
                ...
                fila = bd.rawQuery("SELECT * FROM exam_table WHERE date='"+yearsystem+"' AND status='Upcoming' AND beforetime='"+formattedTime+"'", null);
                if(fila.moveToFirst()){
    ...
    private void triggerNotification(Context contexto, String t) {
        ...
        builder.setContentIntent(contentIntent)
                ...
                .setTicker("")
                .setContentTitle("YOU HAVE EXAM FOR "+title+ " in an hour!")
                .setContentText("Your exam starts in an hour! God bless!")
                .setContentInfo("Info")
                .setLargeIcon(BitmapFactory.decodeResource(contexto.getResources(), R.drawable.calendar))
        ...
        Notification notificacion = new NotificationCompat.BigTextStyle(builder)
                .bigText(t)
                .setBigContentTitle("YOU HAVE EXAM FOR "+title+ " in an hour!")
                .setSummaryText("Your exam starts in an hour! God bless!")
                .build();
